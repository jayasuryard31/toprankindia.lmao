...
export const CITY_BILLBOARD_LOCATIONS = [
  ...
  // ── TIMES SQUARE NORTH FRONTAGE (#11 – #19) ──────────────────────────
  {
    ...
    mount: "facade",
    anchor: "times",
    getPos: (p) => ({ x: p.cx - 30, z: p.z0 - 15, yaw: 0 }),
  },
  {
    billboardNumber: 12,
    ...
    mount: "facade",
    anchor: "times",
    getPos: (p) => ({ x: p.cx + 34, z: p.z0 - 15, yaw: 0 }),
  },
  {
    billboardNumber: 13,
    ...
    mount: "facade",
    anchor: "times",
    getPos: (p) => ({ x: p.cx + 2, z: p.z0 - 15, yaw: 0 }),
  },
  {
    billboardNumber: 14,
    id: "bb_ts_north_facade_w",
    ...
    mount: "facade",
    anchor: "times",
    getPos: (p) => ({ x: p.cx - 54, z: p.z0 - 15, yaw: 0 }),
  },
  {
    billboardNumber: 15,
    id: "bb_ts_north_facade_e",
    ...
    mount: "facade",
    anchor: "times",
    getPos: (p) => ({ x: p.cx + 56, z: p.z0 - 15, yaw: 0 }),
  },
  {
    billboardNumber: 16,
    id: "bb_ts_north_upper",
    ...
    mount: "facade",
    anchor: "times",
    getPos: (p) => ({ x: p.cx - 12, z: p.z0 - 15, yaw: 0 }),
  },
  {
    billboardNumber: 17,
    id: "bb_ts_north_ribbon_1",
  ...
  },
  {
    ...
    mount: "facade",
    anchor: "times",
    getPos: (p) => ({ x: p.cx + 20, z: p.z0 - 15, yaw: 0 }),
  },
  ...
  // ── TIMES SQUARE SOUTH FRONTAGE & LANDMARK TOWER (#20 – #30) ─────────
  {
    ...
    mount: "facade",
    anchor: "times",
    getPos: (p) => ({ x: p.cx + 30, z: p.z1 + 15, yaw: Math.PI }),
  },
  {
    billboardNumber: 21,
    ...
    mount: "facade",
    anchor: "times",
    getPos: (p) => ({ x: p.cx - 24, z: p.z1 + 15, yaw: Math.PI }),
  },
  {
    billboardNumber: 22,
    ...
    mount: "facade",
    anchor: "times",
    getPos: (p) => ({ x: p.cx - 46, z: p.z1 + 15, yaw: Math.PI }),
  },
  {
    billboardNumber: 23,
    id: "bb_ts_south_facade_w",
    ...
    mount: "facade",
    anchor: "times",
    getPos: (p) => ({ x: p.cx - 54, z: p.z1 + 15, yaw: Math.PI }),
  },
  {
    billboardNumber: 24,
    id: "bb_ts_south_facade_e",
    ...
    mount: "facade",
    anchor: "times",
    getPos: (p) => ({ x: p.cx + 56, z: p.z1 + 15, yaw: Math.PI }),
  },
  {
    billboardNumber: 25,
    id: "bb_ts_south_upper",
    ...
    mount: "facade",
    anchor: "times",
    getPos: (p) => ({ x: p.cx + 12, z: p.z1 + 15, yaw: Math.PI }),
  },
  {
    billboardNumber: 26,
    id: "bb_ts_landmark_lower",
    ...
    mount: "facade",
    anchor: "times",
    getPos: (p) => ({ x: p.cx + 62, z: p.z1 + 15, yaw: Math.PI }),
  },
  {
    billboardNumber: 27,
    id: "bb_ts_landmark_mid_1",
  ...
  },
  {
    ...
    mount: "facade",
    anchor: "times",
    getPos: (p) => ({ x: p.x1 + 18.8, z: p.cz, yaw: -Math.PI / 2 }),
  },
  {
    billboardNumber: 38,
    id: "bb_ts_east_ribbon_1",
    ...
    mount: "facade",
    anchor: "times",
    getPos: (p) => ({ x: p.x1 + 18.8, z: p.cz - 20, yaw: -Math.PI / 2 }),
  },
  {
    billboardNumber: 39,
    id: "bb_ts_east_ribbon_2",
  ...
  },
  {
    ...
    mount: "facade",
    anchor: "times",
    getPos: (p) => ({ x: p.x1 + 18.8, z: p.cz + 50, yaw: -Math.PI / 2 }),
  },
  {
    billboardNumber: 41,
    id: "bb_ts_east_wall_2",
  ...
  },
  {
    ...
    mount: "facade",
    anchor: "times",
    getPos: (p) => ({ x: p.x0 - 18.8, z: p.cz, yaw: Math.PI / 2 }),
  },
  {
    billboardNumber: 49,
    id: "bb_ts_west_ribbon_1",
    ...
    mount: "facade",
    anchor: "times",
    getPos: (p) => ({ x: p.x0 - 18.8, z: p.cz + 20, yaw: Math.PI / 2 }),
  },
  {
    billboardNumber: 50,
    id: "bb_ts_west_ribbon_2",
  ...
  },
  {
    ...
    mount: "facade",
    anchor: "times",
    getPos: (p) => ({ x: p.x0 - 18.8, z: p.cz - 50, yaw: Math.PI / 2 }),
  },
  {
    billboardNumber: 52,
    id: "bb_ts_west_wall_2",
